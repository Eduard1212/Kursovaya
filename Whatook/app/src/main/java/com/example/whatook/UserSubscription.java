...
class DBHUserSubscriptions extends SQLiteOpenHelper {
    ...
    static final String COLUMN_USER_ID1 = "UserId1";
    static final String COLUMN_USER_ID2 = "UserId2";
    private Context myContext;

    DBHUserSubscriptions(Context context) {
